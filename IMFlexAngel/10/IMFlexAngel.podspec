...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/IMFlexAngel"
  ...
  s.source       = { :git => "https://github.com/pterXX/IMFlexAngel.git", :tag => s.version.to_s }
  ...
  s.source_files  = "IMFlexAngel/IMFlexAngel/**/*.{h,m,swift}"
